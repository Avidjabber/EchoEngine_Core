...
async function main() {
  ...
  try {
    ...
    // --- UpgradeEffectType ---
    const _all = { isStorage: true, isFarming: true, isHousing: true, isMedical: true, isCrafting: true, isCompost: true, isPower: true }
    await prisma.upgradeEffectType.createMany({
      skipDuplicates: true,
      data: [
        { name: 'solid_capacity',        isStorage: true,  isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'liquid_capacity',       isStorage: true,  isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'rot_modifier',          isStorage: true,  isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'security_rating',       isStorage: true,  isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'plot_count',            isStorage: false, isFarming: true,  isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'growth_rate',           isStorage: false, isFarming: true,  isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'env_override',          ..._all,                                                                                                                       requiresEnvTarget: true  },
        { name: 'env_inject',            ..._all,                                                                                                                       requiresEnvTarget: true  },
        { name: 'soil_quality',          isStorage: false, isFarming: true,  isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'comfortable_capacity',  isStorage: false, isFarming: false, isHousing: true,  isMedical: false, isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'max_capacity',          isStorage: false, isFarming: false, isHousing: true,  isMedical: false, isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'treatment_bonus',       isStorage: false, isFarming: false, isHousing: false, isMedical: true,  isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'exam_bonus',            isStorage: false, isFarming: false, isHousing: false, isMedical: true,  isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'recovery_modifier',     isStorage: false, isFarming: false, isHousing: false, isMedical: true,  isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'contagion_resist',      isStorage: false, isFarming: false, isHousing: false, isMedical: true,  isCrafting: false, isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'crafting_roll_bonus',   isStorage: false, isFarming: false, isHousing: false, isMedical: false, isCrafting: true,  isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'output_quantity_bonus', isStorage: false, isFarming: false, isHousing: false, isMedical: false, isCrafting: true,  isCompost: false, isPower: false, requiresEnvTarget: false },
        { name: 'conversion_speed',      isStorage: false, isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: true,  isPower: false, requiresEnvTarget: false },
        { name: 'fuel_capacity',         isStorage: false, isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: true,  requiresEnvTarget: false },
        { name: 'fuel_efficiency',       isStorage: false, isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: true,  requiresEnvTarget: false },
        { name: 'passive_gen_rate',      isStorage: false, isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: false, isPower: true,  requiresEnvTarget: false },
        { name: 'weight_capacity',       isStorage: false, isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: true,  isPower: false, requiresEnvTarget: false },
        { name: 'volume_capacity',       isStorage: false, isFarming: false, isHousing: false, isMedical: false, isCrafting: false, isCompost: true,  isPower: false, requiresEnvTarget: false },
