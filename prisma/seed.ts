...
async function main() {
  ...
  try {
    ...
    // --- SymptomFlavorText + Symptom_FlavorText ---
    // One ambient message template per symptom, seeded globally.
    // Guard ensures this block is skipped on re-runs.
    const existingFTCount = await prisma.symptomFlavorText.count()
    if (existingFTCount === 0) {
      const symptomRows = await prisma.symptom.findMany({ select: { id: true, name: true } })
      const symMap = new Map(symptomRows.map(r => [r.name, r.id]))

      const pairs: { symptomName: string; text: string }[] = [
        // RESPIRATORY
        { symptomName: 'Runny Nose',                              text: `{name}'s nose has been running all day, leaving damp traces on their face.` },
        { symptomName: 'Sneezing',                                text: `{name} let out a sudden sneeze that scattered the nearby bedding.` },
        { symptomName: 'Nasal Bleeding',                          text: `A thin trail of blood was spotted beneath {name}'s nose.` },
        { symptomName: 'Congestion',                              text: `{name} has been breathing through their mouth, their nose seemingly blocked.` },
        { symptomName: 'Coughing',                                text: `{name} was heard coughing fitfully in the night.` },
        { symptomName: 'Sore Throat',                             text: `{name} winced when swallowing their meal, favoring one side of their throat.` },
        { symptomName: 'Wheezing',                                text: `A faint wheeze follows {name}'s every breath.` },
        { symptomName: 'Rattling Breath',                         text: `{name}'s breathing carries an unsettling rattle.` },
        { symptomName: 'Rapid Breathing',                         text: `{name} has been breathing rapidly, even while resting.` },
        { symptomName: 'Labored Breathing',                       text: `Each breath {name} takes appears to cost them considerable effort.` },
        { symptomName: 'Difficulty Breathing',                    text: `{name} has been pausing frequently, struggling to catch their breath.` },
        { symptomName: 'Open-mouth Breathing',                    text: `{name} has been keeping their mouth open, even in the cool air.` },
        { symptomName: 'Gasping for Air',                         text: `{name} was seen gasping for air near the food stores.` },
        { symptomName: 'Cyanosis (Bluish Tongue/Gums)',           text: `{name}'s tongue and gums have taken on an unusual bluish hue.` },
        { symptomName: 'Choking',                                 text: `{name} was seen gagging and clawing at their throat.` },
        // NEUROLOGICAL
        { symptomName: 'Unconsciousness',                         text: `{name} was found unresponsive and could not be roused.` },
        { symptomName: 'Seizure',                                 text: `{name} collapsed suddenly, their limbs seizing uncontrollably for several heartbeats.` },
        { symptomName: 'Tremors',                                 text: `A subtle trembling runs through {name}'s body, even at rest.` },
        { symptomName: 'Disorientation',                          text: `{name} wandered past their own bedding twice before settling.` },
        { symptomName: 'Dizziness',                               text: `{name} stumbled when turning their head, nearly losing their footing.` },
        { symptomName: 'Confusion',                               text: `{name} stared blankly when spoken to, slow to respond.` },
        { symptomName: 'Memory Loss',                             text: `{name} asked about a meal they had already eaten this morning.` },
        { symptomName: 'Head Tilt',                               text: `{name} has been holding their head at an odd angle all day.` },
        { symptomName: 'Circling',                                text: `{name} was spotted walking in tight circles near the camp entrance.` },
        { symptomName: 'Loss of Coordination (Ataxia)',           text: `{name}'s limbs seem to be working against each other.` },
        { symptomName: 'Hyperactivity',                           text: `{name} has barely rested, moving restlessly from place to place without purpose.` },
        { symptomName: 'Depression (Low Mood / Unresponsiveness)', text: `{name} has been sitting alone at the edge of camp, uninterested in the day's activities.` },
        { symptomName: 'Hallucination-like Behavior',             text: `{name} startled at nothing, their gaze fixed on an empty patch of ground.` },
        { symptomName: 'Sensitivity to Sound',                    text: `{name} flinched sharply at a sound no one else seemed to notice.` },
        { symptomName: 'Sudden Personality Change',               text: `Those who know {name} well have noticed something unsettling in how they carry themselves today.` },
        // DIGESTIVE
        { symptomName: 'Vomiting',                                text: `{name} was found retching alone before dawn.` },
        { symptomName: 'Nausea',                                  text: `{name} turned away from their food without eating, looking unwell.` },
        { symptomName: 'Diarrhea',                                text: `{name} has made several trips to the latrine today.` },
        { symptomName: 'Constipation',                            text: `{name} was seen straining at the latrine but returned without relief.` },
        { symptomName: 'Loss of Appetite',                        text: `{name} left their food untouched again today.` },
        { symptomName: 'Bellyache',                               text: `{name} has been curled tightly around their belly for most of the afternoon.` },
        { symptomName: 'Bloating',                                text: `{name}'s belly appears more rounded than usual.` },
        { symptomName: 'Excessive Gas',                           text: `An unpleasant odor has been following {name} around camp today.` },
        { symptomName: 'Straining to Defecate',                   text: `{name} returned from the latrine with discomfort plain on their face.` },
        { symptomName: 'Blood in Stool',                          text: `Something troubling was discovered at the latrine, apparently left by {name}.` },
        { symptomName: 'Black/Tarry Stool',                       text: `A dark, foul-smelling deposit was found at the latrine, believed to be {name}'s.` },
        { symptomName: 'Regurgitation',                           text: `{name} regurgitated their meal shortly after eating.` },
        { symptomName: 'Difficulty Swallowing',                   text: `{name} struggled to get even a small bite of food down without discomfort.` },
        // CARDIOVASCULAR
        { symptomName: 'Irregular Heartbeat',                     text: `{name}'s heartbeat seemed to skip and stutter when listened to closely.` },
        { symptomName: 'Weak Pulse',                              text: `{name}'s pulse is faint and difficult to find.` },
        { symptomName: 'Fainting (Syncope)',                      text: `{name} went limp without warning and had to be steadied before hitting the ground.` },
        { symptomName: 'Cold Extremities',                        text: `{name}'s extremities were noticeably cold to the touch despite the mild weather.` },
        // URINARY / REPRODUCTIVE
        { symptomName: 'Frequent Urination',                      text: `{name} has visited the latrine far more often than usual today.` },
        { symptomName: 'Painful Urination',                       text: `{name} was heard making small sounds of pain at the latrine.` },
        { symptomName: 'Blood in Urine',                          text: `Something alarming was noticed at the latrine, suggesting {name} may be unwell.` },
        { symptomName: 'Incontinence',                            text: `A damp patch was found near where {name} had been sleeping.` },
        { symptomName: 'Strong Urine Odor',                       text: `An unusually sharp odor seems to follow {name} from the latrine.` },
        { symptomName: 'Swollen Abdomen (Fluid Buildup)',         text: `{name}'s belly has been swelling in a way that doesn't look like healthy weight gain.` },
        { symptomName: 'Low Milk Production',                     text: `{name}'s offspring have been crying more than usual, unsatisfied after nursing.` },
        // MUSCULOSKELETAL
        { symptomName: 'Limping',                                 text: `{name} has been favoring one leg today, placing less weight on it with each step.` },
        { symptomName: 'Paralysis',                               text: `{name} was found unable to move their hindquarters.` },
        { symptomName: 'Stiffness',                               text: `{name} rose from their resting place slowly this morning, each movement careful and deliberate.` },
        { symptomName: 'Joint Pain',                              text: `{name} winced quietly when their leg was brushed, though they tried to hide it.` },
        { symptomName: 'Broken Bone',                             text: `{name} cried out when putting weight on one leg and has been reluctant to walk on it since.` },
        { symptomName: 'Sprain',                                  text: `{name} returned from patrol with a pronounced limp.` },
        { symptomName: 'Muscle Cramps',                           text: `{name} was found frozen mid-step, waiting for a cramp to pass.` },
        { symptomName: 'Muscle Rigidity',                         text: `{name}'s movements have become unusually stiff and stilted.` },
        { symptomName: 'Muscle Wasting',                          text: `{name} appears thinner than before, particularly around the haunches.` },
        { symptomName: 'Trembling When Standing',                 text: `{name} trembled visibly while trying to hold themselves upright.` },
        { symptomName: 'Reluctance to Move',                      text: `{name} has remained in their resting place all day, reluctant to stir.` },
        { symptomName: 'Difficulty Rising',                       text: `{name} struggled to push themselves upright this morning.` },
        { symptomName: 'Loss of Balance',                         text: `{name} stumbled sideways while simply standing still.` },
        { symptomName: 'Numbness',                                text: `{name} showed no reaction when their foot was carefully prodded.` },
        // SYSTEMIC / GENERAL
        { symptomName: 'Fever',                                   text: `{name}'s body radiates an unusual heat, their nose dry to the touch.` },
        { symptomName: 'Chills',                                  text: `{name} has been shivering despite the warmth of the den.` },
        { symptomName: 'Fatigue',                                 text: `{name} dozed off mid-sentence while talking to a companion.` },
        { symptomName: 'Lethargy',                                text: `{name} has barely stirred from their resting place, moving only when necessary.` },
        { symptomName: 'Weakness',                                text: `{name} struggled to carry even a small amount of food back to camp.` },
        { symptomName: 'Shivering',                               text: `{name} has been shivering steadily since returning from patrol.` },
        { symptomName: 'Panting',                                 text: `{name} has been panting heavily, their tongue lolling even in the shade.` },
        { symptomName: 'Dehydration',                             text: `{name}'s skin tented slightly when gently pinched — they haven't been drinking enough.` },
        { symptomName: 'Excessive Thirst',                        text: `{name} has visited the water source more times today than anyone can count.` },
        { symptomName: 'Weight Loss',                             text: `{name} looks notably leaner than they did recently.` },
        { symptomName: 'Visible Ribs',                            text: `{name}'s ribs are visible when they stretch, despite eating regularly.` },
        { symptomName: 'Emaciation',                              text: `{name} looks gaunt, their bones pressing visibly through their thinning skin.` },
        { symptomName: 'Pot Belly',                               text: `{name}'s belly hangs low and round, out of proportion with the rest of their frame.` },
        { symptomName: 'Hunger Pangs',                            text: `{name} was caught raiding the food stores in the early morning hours.` },
        { symptomName: 'Shock',                                   text: `{name} was found sitting with a blank stare, unresponsive and limp.` },
        { symptomName: 'Sudden Collapse',                         text: `{name} dropped without warning during the morning gathering.` },
        { symptomName: 'Failure to Thrive',                       text: `{name} has not grown as expected and seems weaker than others their age.` },
        { symptomName: 'Heat Intolerance',                        text: `{name} retreated to the shadiest corner of camp and refused to move during the afternoon.` },
        { symptomName: 'Cold Intolerance',                        text: `{name} pressed close to their companions for warmth even though the air is mild.` },
        { symptomName: 'Night Sweats',                            text: `{name}'s bedding was found damp with sweat despite the cool night air.` },
        { symptomName: 'Enlarged Organs',                         text: `{name}'s belly feels firm and swollen in a way that didn't used to be there.` },
        { symptomName: 'Swollen Lymph Nodes',                     text: `Small, firm lumps were felt beneath {name}'s jaw during an examination.` },
        { symptomName: 'Aggression',                              text: `{name} snapped at a companion without apparent cause.` },
        { symptomName: 'Restlessness',                            text: `{name} paced the length of the camp deep into the night.` },
        { symptomName: 'Anxiety',                                 text: `{name} startled at every sound today, unable to settle.` },
        { symptomName: 'Withdrawal',                              text: `{name} has been avoiding their usual company, retreating to a quiet corner.` },
        // WOUNDS / SKIN
        { symptomName: 'Bleeding',                                text: `{name} was seen with blood matting around a wound.` },
        { symptomName: 'Wound',                                   text: `{name} was spotted tending to a fresh injury on their side.` },
        { symptomName: 'Pain',                                    text: `{name} flinched when a companion brushed against them.` },
        { symptomName: 'Burn',                                    text: `{name}'s skin is visibly singed, raw and tender to the touch.` },
        { symptomName: 'Blistering',                              text: `Fluid-filled swellings were found on {name}'s flank.` },
        { symptomName: 'Bruising',                                text: `Dark patches were found beneath {name}'s skin, tender to the touch.` },
        { symptomName: 'Itching',                                 text: `{name} has been scratching at the same spot relentlessly.` },
        { symptomName: 'Pus',                                     text: `A foul-smelling yellow discharge was found seeping from a wound on {name}.` },
        { symptomName: 'Swelling',                                text: `A notable lump has appeared on {name}'s leg, warm and firm.` },
        { symptomName: 'Rash',                                    text: `A patch of irritated, reddened skin was found on {name}'s flank.` },
        { symptomName: 'Discharge',                               text: `An unusual fluid was found seeping from one of {name}'s wounds.` },
        { symptomName: 'Inflammation',                            text: `The skin around {name}'s injury is hot, tight, and visibly swollen.` },
        { symptomName: 'Infection',                               text: `{name}'s wound has taken on an angry red color and an unpleasant smell.` },
        { symptomName: 'Festering Wound',                         text: `{name}'s wound has not closed and appears to be worsening.` },
        { symptomName: 'Hair Loss',                               text: `A bare patch has appeared on {name}'s coat.` },
        { symptomName: 'Matted Fur',                              text: `{name}'s coat is tangled and matted, something unusual for them.` },
        { symptomName: 'Dry Skin',                                text: `{name}'s coat has been dull and flaky lately.` },
        { symptomName: 'Hot Spots',                               text: `{name} has been worrying at one spot on their flank until it is raw.` },
        { symptomName: 'Scabs',                                   text: `Several crusty scabs have formed along {name}'s back.` },
        { symptomName: 'Flaky Skin (Dandruff)',                   text: `A dusting of white flakes falls from {name}'s coat when they move.` },
        { symptomName: 'Thickened Skin',                          text: `A rough, leathery patch has formed on the sole of {name}'s foot.` },
        { symptomName: 'Skin Discoloration',                      text: `An area of {name}'s skin has changed to an unusual color.` },
        // HEAD / SENSES
        { symptomName: 'Glazed Eyes',                             text: `{name}'s eyes have a distant, unfocused quality to them.` },
        { symptomName: 'Sunken Eyes',                             text: `{name}'s eyes look sunken, the hollows around them more pronounced than usual.` },
        { symptomName: 'Cloudy Eye',                              text: `One of {name}'s eyes has a milky cloudiness to it.` },
        { symptomName: 'Squinting',                               text: `{name} has been squinting against the daylight.` },
        { symptomName: 'Red Eyes',                                text: `The whites of {name}'s eyes are rimmed with red.` },
        { symptomName: 'Eye Discharge',                           text: `Crusty discharge has been collecting in the corners of {name}'s eyes.` },
        { symptomName: 'Dilated Pupils',                          text: `{name}'s pupils are wide even in bright light.` },
        { symptomName: 'Unequal Pupil Size',                      text: `{name}'s pupils are mismatched, one noticeably larger than the other.` },
        { symptomName: 'Loss of Vision',                          text: `{name} misjudged a jump they would normally make with ease.` },
        { symptomName: 'Sensitivity to Light',                    text: `{name} kept their eyes half-closed and turned away from the sun all day.` },
        { symptomName: 'Blurred Vision',                          text: `{name} has been squinting and moving closer to examine things they normally see clearly.` },
        { symptomName: 'Loss of Hearing',                         text: `{name} didn't respond when called from across camp.` },
        { symptomName: 'Head Shaking',                            text: `{name} has been shaking their head repeatedly throughout the day.` },
        { symptomName: 'Ear Discharge',                           text: `A dark, waxy discharge was spotted inside {name}'s ear.` },
        { symptomName: 'Ear Odor',                                text: `An unpleasant smell was noticed when {name} shook their head nearby.` },
        { symptomName: 'Bad Breath',                              text: `{name}'s breath has been notably unpleasant today.` },
        { symptomName: 'Gum Swelling',                            text: `{name}'s gums look red and puffy when they open their mouth.` },
        { symptomName: 'Pale Gums',                               text: `{name}'s gums are pale, nearly white.` },
        { symptomName: 'Yellowing Gums',                          text: `{name}'s gums have taken on a yellowish tint.` },
        { symptomName: 'Foaming at Mouth',                        text: `{name} was found with foam gathering at the corners of their mouth.` },
        { symptomName: 'Toothache',                               text: `{name} has been avoiding chewing on one side.` },
        // OTHER
        { symptomName: 'Hypersensitivity',                        text: `{name} recoiled sharply when touched, as if the lightest contact caused pain.` },
        { symptomName: 'Respiratory Illness',                     text: `{name} has been struggling with their breathing throughout the day.` },
        { symptomName: 'Poisoning',                               text: `{name} is showing signs of severe distress — something is deeply wrong.` },
        { symptomName: 'Drooling',                                text: `Drool has been gathering at the corners of {name}'s mouth.` },
      ]

      const createdTexts = await prisma.symptomFlavorText.createManyAndReturn({
        data: pairs.map(p => ({ text: p.text })),
      })

      await prisma.symptom_FlavorText.createMany({
        data: pairs
          .map((p, i) => ({ symptomId: symMap.get(p.symptomName), flavorTextId: createdTexts[i].id }))
          .filter((r): r is { symptomId: number; flavorTextId: number } => r.symptomId !== undefined),
      })
    }
