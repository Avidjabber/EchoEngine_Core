...
import { uploadActionPack, UploadResultRow } from '../../../../services/model/actionPackService';
...
export async function execute(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    const result = await uploadActionPack(interaction.guildId!, buffer);
    ...
    const csv = new AttachmentBuilder(buildCsv(rows), { name: 'actions-result.csv' });
